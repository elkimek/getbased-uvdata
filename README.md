...
- **Memory footprint** is bounded by the configured grid, forecast horizon, and requested variable roster; adding direct total/clear-sky UV fields increases it relative to older four-field snapshots.
